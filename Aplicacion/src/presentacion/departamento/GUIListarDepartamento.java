...
public class GUIListarDepartamento extends JFrame implements GUI {
	
	private static final long serialVersionUID = 1L;
	
	private JTable table;
	
	private String[] columnNames = { "#", "Id", "Nombre", "Fondos" };
	
	private DefaultTableModel tableModel;
	
	public GUIListarDepartamento() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		northPanel.add(new JLabel("Listar Departamentos"));
		...
		button.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(new Contexto(Events.LISTAR_DEPARTAMENTO, null));
	...
	public void update(Contexto contexto) {
		...
		List<Departamento> res = (List<Departamento>) contexto.getDato();
