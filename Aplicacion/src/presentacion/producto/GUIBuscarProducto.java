...
public class GUIBuscarProducto extends JFrame implements GUI {
	
	private static final long serialVersionUID = -7594657999070180514L;

	private String[] labels = { "Id", "Nombre", "Precio","Unidades" };
	...
	public void update(Contexto contexto) {
		...
		TProducto producto = (TProducto) contexto.getDato();
		
		texts[0].setText("" + producto.getId());
		
		texts[1].setText("" + producto.getNombre());
		
		texts[2].setText("" + producto.getPrecio());
		
		texts[3].setText("" + producto.getUnidades());
