...
public class GUIAltaTrabajadorTiempoParcial extends JFrame implements GUI {
	
	private static final long serialVersionUID = -1152764755433638331L;
	
	private String[] labels = { "Nombre", "Correo", "Departamento", "Sueldo/Hora", "Horas/Jornada" };
	private JTextField[] texts = new JTextField[labels.length];

	public GUIAltaTrabajadorTiempoParcial(){
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Trabajador Tiempo Parcial"));
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
								...
								departamento.setId(Integer.parseInt(out[2]));
								Controlador.getInstance().accion(new Contexto(Events.ALTA_TRABAJADOR_TIEMPO_PARCIAL, 
										new TiempoParcial(
												out[0], 
												out[1], 
												departamento,
