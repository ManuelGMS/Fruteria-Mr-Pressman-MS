...
public class GUIAltaTrabajadorTiempoCompleto extends JFrame implements GUI {
	
	private static final long serialVersionUID = -1152764755433638331L;
	
	private String[] labels = { "Nombre", "Correo", "Departamento", "Sueldo", "Antiguedad" };
	private JTextField[] texts = new JTextField[labels.length];

	public GUIAltaTrabajadorTiempoCompleto(){
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Trabajador Tiempo Completo"));
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
								...
								Controlador.getInstance().accion(new Contexto(Events.ALTA_TRABAJADOR_TIEMPO_COMPLETO, 
										new TiempoCompleto(
												out[0], 
												out[1], 
												departamento,
