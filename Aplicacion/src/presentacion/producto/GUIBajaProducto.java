...
public class GUIBajaProducto extends JFrame implements GUI {
	...
	private static final long serialVersionUID = -4556407580880955807L;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (create) {
					...
					try {
						...
						Controlador.getInstance().accion(new Contexto(Events.BAJA_PRODUCTO, Integer.parseInt(out[0])));
