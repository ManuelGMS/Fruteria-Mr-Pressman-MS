...
public class GUIProductosCompradosPorClienteVIP extends JFrame implements GUI {

	private static final long serialVersionUID = 6679287605533487722L;
	...
	public GUIProductosCompradosPorClienteVIP(){
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		mainPanel.setResizeWeight(0.5);
			...
			JPanel leftPanel = new JPanel(new BorderLayout(10, 10));
				...
				northPanel.add(new JLabel("Productos comprados por cliente VIP"));
					...
					button.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent e) {
							...
							if (create) {
								...
								try {
								Controlador.getInstance().accion(new Contexto(Events.PRODUCTOS_MAS_COMPRADOS_VIP, Integer.parseInt(out[0])));
								} catch (Exception ex) {
