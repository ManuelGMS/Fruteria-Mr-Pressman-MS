...
public class GUIAltaDepartamento extends JFrame implements GUI {
	
	private static final long serialVersionUID = 1L;
	
	private String[] labels = { "Nombre", "Fondos" };
	...
	private void initGUI() {
		...
		northPanel.add(new JLabel("Alta Departamento"));
