...
public class GUIActualizarDepartamento extends JFrame implements GUI{
	...
	public GUIActualizarDepartamento() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		northPanel.add(new JLabel("Actualizar Departamento"));
				...
				if (create) {
					...
					try {
						...
						Controlador.getInstance().accion(
							new Contexto(
							Events.ACTUALIZAR_DEPARTAMENTO, 	
								new Departamento(
