...
public class GUIAltaClienteNoVIP extends JFrame implements GUI {
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(new Contexto(Events.ALTA_CLIENTE_NO_VIP, 
