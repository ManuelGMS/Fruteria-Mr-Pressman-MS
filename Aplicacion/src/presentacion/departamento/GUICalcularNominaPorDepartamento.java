...
public class GUICalcularNominaPorDepartamento  extends JFrame implements GUI{
	
	private static final long serialVersionUID = 1L;
	private String[] labels = { "Id"};
	private JTextField[] texts = new JTextField[labels.length];
	
	public GUICalcularNominaPorDepartamento() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Calcular nominas por Departamento"));
						...
						if (create) {			
							...
							try {
								...
								Controlador.getInstance().accion(
									new Contexto(
										Events.CALCULAR_NOMINAS_TRABAJADOR, 
