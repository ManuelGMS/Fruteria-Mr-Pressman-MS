...
public class GUIMatricularTrabajador extends JFrame {
	
	private static final long serialVersionUID = 4353119354123625007L;

	private String[] labels = { "IdCurso", "IdTrabajador" };
	
	private JTextField[] texts = new JTextField[labels.length];

	public GUIMatricularTrabajador() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		northPanel.add(new JLabel("Matricular trabajador."));
